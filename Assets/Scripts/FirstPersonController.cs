...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        [SerializeField] private float snowballReset = 3.0f;


        private float snowballResetTime = 0.0f;
        private bool isSnowBallResetTimerRunning = false;
        ...
        { 
                ...
                snowballBeingThrown.name = "Snowball";
                snowballBeingThrown.GetComponent<Rigidbody>().AddForce(m_Camera.transform.forward * 1000, ForceMode.Force);
